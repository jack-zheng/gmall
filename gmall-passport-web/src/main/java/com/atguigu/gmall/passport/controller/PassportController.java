...
public class PassportController {
    ...
    public String vlogin(String code,HttpServletRequest request){
        ...
        // access token 结合 appid + secret id 获取用户信息
        ...
        // 生成 jwt 的 token, 并且重定向到首页，携带该 token
        ...
        return "redirect:http://127.0.0.1:8073/index"+token;
    }
    ...
    public String verify(String token, String currentIp) {
        ...
        Map<String, Object> decode = JwtUtil.decode(token, "2019gmall0105", "0:0:0:0:0:0:0:1");
